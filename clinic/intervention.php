<?php
    ...
    require_once('database/db_intervention.php');   // Adiciona funções relacionadas às intervenções
    ...
    $listaIntervencoes  = listIntervention();
    ...
    include('templates/tpl_intervention_list.php');
